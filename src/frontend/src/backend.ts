...
export class Backend implements backendInterface {
    ...
    async addVote(arg0: string, arg1: Color, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addVote(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLikedColors(arg0: string): Promise<Array<Color>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLikedColors(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecommendedFamily(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecommendedFamily(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSeason(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSeason(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
